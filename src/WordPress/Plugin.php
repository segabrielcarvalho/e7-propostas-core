...
final class Plugin
{
    ...
    private function register(): void
    {
        add_action('plugins_loaded', function (): void {
            ...
            $invoiceAdmin = new InvoiceAdmin($invoiceRepository, $invoiceService, $artifactDownload);
            ...
            $routes = new PublicRoutes($repository, $invoiceRepository, $artifactVerifier, $artifactDownload, $features);
